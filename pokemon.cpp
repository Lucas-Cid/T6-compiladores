...
int main(){
    ...
    //aqui gera cada skill_ visit declare_skill
    //exKill[name] = new Skill(name, cost, dmg, 0, type);

    map<string, Pokemon> poquemao;

    //aqui gera pokemom_ visit declare_pokemon
    // para cada skill
    map<string, Skill> skills;
    Skill aux;
    /**
     ...
     * skills[IDENT] = aux
     */
    //poquemao[name] = new Pokemon(name, hp, pp, type, skills)
    //skills.clear()
    ...
    /**
     * if(!poquemao[IDENT.get(0)].attack(poquemao[IDENT.get(2)], IDENT.get(1))){
     *      atksInvalidos[{min(string(IDENT.get(0)),string(IDENT.get(2)))}]++;
     * }
     * 
     * 
     */
