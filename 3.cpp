    ...
    bool attack(Pokemon &a, string skillName){
        ...
        if(a.hp <= 0){
            cout << ">>>>>>>>>>>> " + this->name + " DECLARADO VENCEDOR DA BATALHA CONTRA " + a.name + " <<<<<<<<<<<<"<< endl;
                if(PokemonToAsciiIdx.find(this->name) != PokemonToAsciiIdx.end())
                        print_pokemon(PokemonToAsciiIdx[this->name])
;        }
        cout << endl;
        return true;
    }
...
int main(){
    ...
    poquemao["Mew"] = Pokemon("Mew", 100, 50, "fire", skills);
    skills.clear();
    skls = {{"raio", 3}};
    for(auto i : skls){
        Skill aux;
    ...
    poquemao["Mewtwo"] = Pokemon("Mewtwo", 150, 30, "eletric", skills);
    map<pair<string, string>, int> atksInvalidos;
    vector<vector<string>> attck = {{"Mewtwo", "raio", "Mew"},{"Mewtwo", "raio", "Mew"},{"Mewtwo", "raio", "Mew"}    };
    for(auto i : attck){
